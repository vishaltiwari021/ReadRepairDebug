  ...
  return (
    <div className="card bg-base-100 shadow-sm border border-base-300 h-full">
      <div className="card-body p-6 flex flex-col h-full">
        ...
        <div className="flex-grow bg-neutral text-neutral-content rounded-xl overflow-hidden shadow-inner">
          <div className="px-4 py-2 bg-neutral-focus border-b border-neutral-content/10 flex gap-2 items-center">
